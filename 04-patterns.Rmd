...
```{r hickey-before, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='Are there any differences among the pollings at points A, B and C?'}
knitr::include_graphics("img/hickey-before.jpg")
```

```{r hickey-after, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='The differences can be clearly told from the bar charts.'}
...
```{r hickey-breakdown, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='It is hard to compare the size of the slides.'}
knitr::include_graphics("img/hickey-breakdown.jpg")
```

3. Pie chart is easy to be manipulated (e.g. using a 3D pie chart). See figure \@ref(fig:hickey-3D) for example.

```{r hickey-3D, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='S&D (red) appears to be roughly even with EPP (teal) in a 3D pie chart!'}
knitr::include_graphics("img/hickey-3D.jpg")
```
...
```{r henry-quarter, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='25%:75% VS 28%:72%'}
knitr::include_graphics("img/henry-quarter.jpeg")
```

```{r henry-half, echo=FALSE, out.width='70%', fig.show='hold', fig.cap='50%:50% VS 48%:52%'}
knitr::include_graphics("img/henry-half.jpeg")
```
