...
ggplot(data = mpg, mapping = aes(x = class, y = hwy)) +  geom_boxplot() +  
  coord_flip()
```
3. coord_quickmap() sets the aspect ratio correctly for maps. This is very important if you draw a map.

4. coord_polar() uses polar coordinates. Polar coordinates reveal interesting connections between a bar chart and a Coxcomb chart.
