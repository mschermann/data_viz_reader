...
## 11. An example to back some of our theories on 'how to tell stories using data visualization' / 'exploratory data visualization'
DATA USA :     [@DataUSA]
...
## 12. Reusable Data Visualization Code in R
[@viz_R]
