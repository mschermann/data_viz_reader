...
### Graph Integrity
"Graphics were used as instruments for reasoning quantitative information. With this good exmaple ,graphical workd has come to flourish.Graphical excellence begin with telling the truth about the data(Tufte,2001)".
In Tufte's "The Visual Display of Quantitative Information" book ,he explained how to create a graph integrity visualization with a whole chapter, vey useful and important examples can be found in the book. Following are some examples:
![](image_1.png) 
![](image_2.png)
