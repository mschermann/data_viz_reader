...
![](https://github.com/mschermann/data_viz_reader/blob/week4_contributions/images/pattern-design-1.jpg)
```
...
![](https://github.com/mschermann/data_viz_reader/blob/week4_contributions/images/pattern-design-2.jpg)
```
...
![](https://github.com/mschermann/data_viz_reader/blob/week4_contributions/images/pattern-design-3.png)
```
...
Figure below is a stacked area chart showing time series data:
