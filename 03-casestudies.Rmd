...
**Use cases for graph visualization**  
The contents of this publication are available as a [PDF](https://openknowledge.worldbank.org/handle/10986/29788), the data is available in the [World Bank's Data Catalog](https://datacatalog.worldbank.org/dataset/atlas-sustainable-development-goals-2018-world-development-indicators) and the code used to generate the majority of figures is available on [Github](https://github.com/worldbank/sdgatlas2018). 
