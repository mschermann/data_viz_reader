...
NPR tapped into American Time Use Survey data to ascertain the share of workers in a wide range of industries who are at work at any given time [@NPR_workday]. The unconventional question of when Americans work, rather that the number of hours worked is answered in the graph. The chart overlays the traditional 9 AM-5 PM standard over the graph for a reference point, helping the audience draw interesting conclusions. Below is a screenshot of the data product, the original graph is more interactive and allows the audience to explore when people are working for differnt occupations. 

![](images/npr_workday.png)

Some interesting finds include:
1. Construction workers don't work at lunch hours as there is a huge drop at noon. 
...
3. Protective services, e.g., police officers, firefighters and detectives, have a lot of workers working at 3 a.m., which is quite differnt from all other occupations. 

![](images/protective.png)

This data product is a great example as analytic design has been applied to constrast specific occupation to the traditional 9-5 working hours. This is easy to understand and make speciall occupations stand out easier. The color being used in the graph helps categorizing different occupations as well. 
...
3. Among the youngest generation, white takes only 50% of the population with the potential of dropping from the biggest race in US. 
