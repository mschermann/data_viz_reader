...
An excellent example from the Kissmetrics blog is about Facebook’s organic reach [@facebook_organic]. One crucial point discussed in the blog is whether the Facebook’s organic reach is decreasing drastically. 
...
Using data from the Planetary Habitability Laboratory at the University of Puerto Rico, the interactive graph on [Astrobiology](https://www.nationalgeographic.com/astrobiology/goldilocks-worlds/) plots planetary mass, atmospheric pressure, and temperature to determine what exoplanets might be home, or have been home at one point, to living beings.

One highlight of the graph is how color has been used. The red dots are representing planets that are too hot and the green ones meaning just right temperature, and the blue dots are meaning too cold. This is very intuitive for people to understand without the necessity to read through the notes. The dots are transparent so it minimized the overlap among themselves. 
