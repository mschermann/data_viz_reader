...
In functional data analysis we observe curves deﬁned over a given realinterval and shape outliers may be deﬁned as those curves that exhibit a diﬀerent shape from the rest of the sample. Some more types of outliars observed are:
