...
Case studies contain valuable information about development records. The evaluation and study of case study helps show that the new design is just as usable as existing techniques, making it suitable for future development. Here are some very useful case studies:
...
Many of the case studies below come from the following articles:

**15 Cool Information Graphics and Data Viz from 2016** [@cool_data]
...
**16 Captivating Data Visualization Examples** [@int_viz_1]

**15 Data Visualizations That Explain Trump, the White Oscars and Other Crazy Current Events** [@int_viz_2]
...
## 9. An Aging Nation: Projected Number of Children and Older Adults
...
## 10. A guide to Who is Fighting Whom in Syria
...
## 11. Adding up the White Oscars Winners
...
## 12. Young voters, class and turnout: how Britain voted in 2017
...
## 14. Linguistic Concepts

14. **Case Study on computational linguistics**
...
## 17. Vizwiz blog: case studies about how to improve your visualizations
...
17.An intersting case study could be [@case_thesis]. It is a thesis but it has intersting insights about visualization using mobile data.
...
## 18. 15 Data Visualizations That Will Blow Your Mind

"If a picture is worth a thousand words, a data visualization is worth at least a million.

As inspiration for your own work with data, check out these 15 data visualizations that will wow you. Taken together, this roundup is an at-a-glance representation of the range of uses data analysis has, from pop culture to public good." [@15_mindblowing]

18.1. Every Satellite Orbiting Earth
[@Satellite]
```
@misc{Satellite,
...
18.3. Charles Minard’s Visualization of Napoleon’s 1812 March
...
18.4. Hans Rosling’s 200 Countries, 200 Years, 4 Minutes
...
18.6. State of the Union 2014 Minute by Minute on Twitter
...
18.7. An Interactive Visualization of NYC Street Trees
[@trees]
```
@misc{trees,
...
18.8. Millennial generation is bigger, more diverse than boomers
[@age_groups]
```
@misc{age_groups,
...
18.10. Washington Wizards’ Shooting Stars
[@basketball]
```
@misc{basketball,
...
## 19. Other sources of great visualization:
...
## 20. Deceptive data graphs examples
...
+ **20.2 The graph isn’t labeled properly.**
...
@misc{one_var_change,
  ...
  year = {2012},	
  title = {Misleading Graphs: Displaying a Change in One Variable Using Area or Volume},
  howpublished = {\url{https://www.forbes.com/sites/naomirobbins/2012/02/28/misleading-graphs-displaying-a-change-in-one-variable-using-area-or-volume/#696674551781}},
  note = {Accessed: 2018-05-12}
}
```
+ **20.3 Data is left out.**
...
+ bar charts without zero & evenly spaced tick marks for uneven intervals: Ref: https://www.forbes.com/sites/naomirobbins/2011/11/17/whats-wrong-with-this-graph/#502ab1a42a33


+ graphs not drawn to scale: 
Ref: https://www.forbes.com/sites/naomirobbins/2012/02/16/misleading-graphs-figures-not-drawn-to-scale/#351dcf9c15ef
...
+ **20.4 Treating correlation as causation.**
...
## 21. Application of Data Visualization
...
##Graph designs by Visualists

## 24. Genetic Network Reconstruction

Data visualization techniques are used to reconstruct genetic networks from genomics data. Reconstructed genetic networks are predicted interactions among genes of interest and these interactions are inferred from genomics data,microarray data or DNA sequence. Genomics data are generally contaminated and high-dimensional. It is important to examine and clean data carefully to attain meaningful inferences. Thus visualization tools that are used in the preprocessing of data associated with genetic network reconstruction are also reviewed and chosen wisely.

## 25. Two Awesome Visualists 

25.1. **DAVID McCANDLESS**
...
## 26. Using Shapes as Filters in Tableau When Your Fields Are Measures
...
https://www.targit.com/en/blog/2015/02/data-visualization-scatter-chart
...
## 27. Visualization of big data security: a case study on the KDD99 cup data set
