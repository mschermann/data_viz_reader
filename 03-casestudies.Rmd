...
### Inveitability of Data Visualization Criticsm - Beauty vs Functionality 

Andy Cotgreave is the current Senior Technical Evangelist at Tableau.  In the linked article he defends the use of elaborate visualizations and argues that beauty is a quality worth pursuing when making data visualizations.  In particular, he is interested in tackling the common criticism of “it would have been better as a line chart."  

One visualization that he focuses on is a work that shows the effect of introducing vaccines on the number of polio cases in the US made by the Wall Street Journal.  Cotgreave contrasts the colorful heatmap, which is harder to parse, and a linegraph that is plain, but easy to understand.  

![](images/which_is_best.png)

In his article, Cotgreave argues that the heatmap was visually striking, and its novelty made him more likely to interact with it.  He later asks the reader whether or not the line version would have won awards, or been virally shared as the heatmap was.  While Cotgreave acknowledges the readability of the line graph, he ultimately feels that there is a place for visualizations to be beautiful.

The article can be found [here](https://www.infoworld.com/article/3048315/the-inevitability-of-data-visualization-criticism.html).
