...
## 1. Best Data Visualizations cases

## 1.1 10 Best Data Visualization Projects of 2015 
...
## 1.2 15 Cool Information Graphics and Data Viz from 2016
[@cool_data]
...
## 1.3 16 Captivating Data Visualization Examples
[@int_viz_capt]

## 1.4 15 Data Visualizations That Will Blow Your Mind
[@15_mindblowing]
=======
...
Visualization is like art. It speaks where words fail. There are phenomena like the Syrian war, the number flights during Thanksgiving in the USA, the understanding of depths for developing a perspective about the range of the issue, the controversy of ‘#OscarsSoWhite’, etc. on which we can write bundles of paragraphs, but they might still have scope for ambiguity. The links show some intricate visualizations of the topics like those mentioned above and speak volumes without requiring paragraphs to explain what is going on within these visualizations. According to me, it is really interesting to see that almost anything in this world can be explained by visualizations. Visualizations are not just limited to businesses and their analytics. Wars, rescue operations, etc. can also be visualized to get a clear idea of all the details of the issues. 
...
## 1.6 How People Like You Spend Their Time
...
## 1.7 Is it Better to Rent or Buy?
...
## 1.8 Two Centuries of U.S. Immigration
...
## 1.9 Hans Rosling’s 200 Countries, 200 Years, 4 Minutes
...
## 2. 15 Data Visualizations That Explain Trump, the White Oscars ,and Other Crazy Current Events
[@int_viz_2]
...
## 2.1 Connecting the Dots Behind the Election
This article by the New York Times lists several different candidates and creates compelling visuals that link their campaigns to previous ones [@campaign_staff][@cool_data]. Each visual contains several different-sized dots that represent a specific campaign, administration, or other governmental organization related to the candidate’s current campaign, which are then connected by arrows. Hovering over a specific dot highlights the connections between the groups. The visual is a great way to put what would otherwise be a long slog through years of information into an easily accessible, easily viewable format so that voters can figure out where the candidates’ experiences lie.

![Clinton 2016 Campaign Staff](images/clinton_campaign.png)

## 3. What's really warming the world?
...
## 4. The Strengths of Animated Data Visualization
...
This one includes a bar chart and a line graph to demonstrate the aging population compared with population of children. The good things about this visualization: simple to see and compare, color to differentiate the category, highlight the intersection point.

## 6. From Pyramid to Pillar: A Century of Change, Population of the U.S.
[@population_pyramid]

![](images/Pyramid.jpg)

This is a **population pyramid**. “A **population pyramid** is a pair of back-to to histograms for each sex that displays the distribution of a population in all age groups and in gender”. It is a good candidate to compare changes in population distributions (sex, age, year). Also the shape of a pyramid is used to interpret a population. To illustrate, A pyramid with a very wide base and a narrow top section suggests a population with both high fertility and death rates. It is a useful tool in the census data. [@animated_pyramid] offers an animated pyramid.
...
## 8. Adding up the White Oscars Winners
...
## 9. Young voters, class and turnout: how Britain voted in 2017
[@UKvotes2017]
...
## 10. Uber: Crafting Data-Driven Maps
[@uber_maps]
...
## 12. Kissmetrics blog: visualization of metrics
[@facebook_organic]
...
##  13. How the Recession Reshaped the Economy, in 255 Charts
[@recession_economy]

The first large graph contains 255 lines to show how the number of jobs has changed for every industry in America. Using color to highlight the lines let viewers see the specifics of each industry. By hovering over a line, the detailed information of that industry's job trend will show up. Keeping this extra data hidden until needed makes it easier for readers to absorb information from this otherwise huge data visualization.
Below the overall chart on top is subsets categorized by job sector and sub-industries. Readers can choose the industry or sector they are interested in and, like in the first graph, view the more detailed information by hovering over a line.
...
## 15. Data Visualization Examples

## 15.1 Every Satellite Orbiting Earth
...
## 15.3 Charles Minard’s Visualization of Napoleon’s 1812 March
...
## 15.5 State of the Union 2014 Minute by Minute on Twitter
...
## 15.9 Washington Wizards’ Shooting Stars
...
## 16. Application of Data Visualization
