...
Such a visualization is ideal for the layman wanting to walk away with a basic but accurate understanding of the dietary changes, but also provides plenty for the more discerning viewer who might have more time and inclination to dissect and parse through the graphs. As such, it is difficult to cater to both types of viewers in such a satisfactory capacity, which is what makes it so alluring and effective.
