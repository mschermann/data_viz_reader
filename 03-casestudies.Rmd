...
2. **16 Captivating Data Visualization Examples**
[@int_viz_1]

3. **15 Data Visualizations That Explain Trump, the White Oscars and Other Crazy Current Events** 
[@int_viz_2]
...
## 3.1 Connecting the Dots Behind the Election
...
## 3.4 How People Like You Spend Their Time
...
## 3.5 Is it Better to Rent or Buy?
[@rent_or_buy]
```
@misc{rent_or_buy,
...
## 3.6 Two Centuries of U.S. Immigration
...
## 3.7 What's Really Warming the World?
...
## 3.8 The Strengths of Animated Data Visualization
...
## 3.9 An Aging Nation: Projected Number of Children and Older Adults
...
3.9.1 An Aging Nation: Projected Number of Children and Older Adults
...
3.9.2 From Pyramid to Pillar: A Century of Change, Population of the U.S.
...
## 3.10 A Guide to Who is Fighting Whom in Syria
...
## 3.11 Adding up the White Oscars Winners
...
## 3.12 Young Voters, Class and Turnout: How Britain Voted in 2017
...
## 3.13 Uber: Crafting Data-Driven Maps
...
## 3.14 **Case Study on Computational Linguistics**
...
## 3.15 Kissmetrics Blog: Visualization of Metrics
...
## 3.16 How the Recession Reshaped the Economy, in 255 Charts
...
## 3.17 Vizwiz blog: How to Improve Your Visualizations
...
## 3.18 15 Data Visualizations That Will Blow Your Mind

"If a picture is worth a thousand words, a data visualization is worth at least a million. As inspiration for your own work with data, check out these 15 data visualizations that will wow you. Taken together, this roundup is an at-a-glance representation of the range of uses data analysis has, from pop culture to public good." [@15_mindblowing]

### 3.18.1 Every Satellite Orbiting Earth
[@Satellite]
```
@misc{Satellite,
...
### 3.18.3 Charles Minard’s Visualization of Napoleon’s 1812 March
...
### 3.18.4 Hans Rosling’s 200 Countries, 200 Years, 4 Minutes
...
### 3.18.6 State of the Union 2014 Minute by Minute on Twitter
...
### 3.18.7 An Interactive Visualization of NYC Street Trees
[@trees]
```
@misc{trees,
...
### 3.18.8 Millennial Generation is Bigger, More Diverse Than Boomers
[@age_groups]
```
@misc{age_groups,
...
### 3.18.10 Washington Wizards’ Shooting Stars
[@basketball]
```
@misc{basketball,
...
### 3.18.11 U.S. Migration Patterns 
[@migration]
```
@misc{migration,
...
### 3.18.14 Global Carbon Emissions
...
## 3.20 Case Studies for Deceptive Data Graphs 
...
### 3.20.2 The graph isn’t labeled properly.
...
### 3.20.4 Treating correlation as causation.
...
## 3.21 Application of Data Visualization
...
## 3.22 Genetic Network Reconstruction

Data visualization techniques are used to reconstruct genetic networks from genomics data. Reconstructed genetic networks are predicted interactions among genes of interest and these interactions are inferred from genomics data,microarray data or DNA sequence. Genomics data are generally contaminated and high-dimensional. It is important to examine and clean data carefully to attain meaningful inferences. Thus visualization tools that are used in the preprocessing of data associated with genetic network reconstruction are also reviewed and chosen wisely.

## 3.23 Two Awesome Visualists 
...
## 3.24 Using Shapes as Filters in Tableau When Your Fields Are Measures
...
## 3.25 Visualization of Big Data Security: a Case Study on the KDD99 Cup Data Set
