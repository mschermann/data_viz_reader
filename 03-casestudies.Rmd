...
Case studies contain valuable information about development records. The evaluation and study of case study helps show that the new design is just as usable as existing techniques, making it suitable for future development. Below are some very useful case studies: 
...
13. **Vizwiz blog: casestudies about how to improve your visualizations**
...
14. **Uber: Crafting Data-Driven Maps**
...
17. **How the Recession Reshaped the Economy, in 255 Charts**
...
18. An intersting case study could be [@case_thesis]. It is a thesis but it has intersting insights about visualization using mobile data.
...
There are ways to use data visualization at every level of an organization. Data Visualization applications lets us quickly create insightful data visualizations, in minutes. It allows users to visualize data and explore the vast domain interactively. Ref: [@app1] Some of the applications are mentioned below:
...
<!--I found this article quite useful for my individual project.-->
