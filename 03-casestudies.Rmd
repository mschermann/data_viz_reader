...
Ref:[@outliar]. Below is a simple example. Outlier treatment is important because it can drastically bias/change the fit estimates and predictions. Illustration: 
...
One such chart, "International Number Ones: Because every country is good at something (according to data)," is a captivating work that displays something at which each country is the best. [@country_chart]
