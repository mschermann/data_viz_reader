...
Data Visualization is a relatively new  and maturing field. And part of that process is determining what is acceptable practice. A visible code of ethics is very important, because it establishes a standard of quality, helps us garner trust from clients, users and viewers, and gives the user a sense of confidence and pride in their work.

We find a lot of debates all over websites about big data causing big problems. On the other hand, some people see big data ushering in and era where businesses have the analytics they need to optimize their returns on investment (ROI).

I recently went through a post defending big data, so you know what side of the debate I’m gonna take. Data is never the problem, in my opinion, it’s the way we use data that causes big problems. 

The look and feel is made such that the essence of data is gone. Here are the major problems cited related to big data visualization:

- Manipulation of consumers
- Violating the privacy of consumers
- Tweaking the data set too much
...
![Detailed Data represented through the Graph](http://static1.squarespace.com/static/56392b2ce4b0632f2c6d74a4/564e06cae4b0f3ea27e47d7a/564e08a4e4b0f3ea27e4d10c/1447954596926/DepthoftheProblem.png?format=original)
