 ...
 **Understanding the data you are trying to visualize:** For instance, the shape and dimension of the data, type of data (time-series or not), relationship in data between entities, and categorical attributes are important prerequisites. Is this data from a single source or multiple sources? If the data is from multiple sources, they need to be blended together without loosing the meta data constraints and business rules. When the data is collected, the end goal should be kept in mind.
