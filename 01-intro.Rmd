...
## A cool website example on 'how to tell stories using data visualization': MIT Media Lab
...
### Emphasizing categorization of information on the website

What stands out is the categorization of information on the website, enabling the following:
...
**Automatic visualization is a bad idea, generally speaking.** Some parts of visualization certainly should be automatic, such as standard chart types and recurring geometries. Annotation and axis construction can be automatic as well. However, full-on automation of data visualization with valuable insights is far-fetched because this would require automatic analysis. 

Furthermore, **the most interesting visualizations are context-specific.** Analytics is usually context-specific and requires more than boilerplate statistics. [@auto_viz]

### Data visualization can't explain data, leaving room for interpretation

According to UI Engineer Alysson Ferreira, there is an increasing need to understand the latest trends quickly and efficiently, which means there's also a need for meaningful sources of trustworthy information. [@UI_engineer]
