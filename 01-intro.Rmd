...
##Data visualization vs Infographics[@VIZ VS INFO]:

Data visualization and infographics both present visual information to users. Although they look similar in their purpose there can be different use cases where each one can be used. In this article we will go over the differences between infographics and data visualization.
