...
Developments in printing and reproduction technologies, mathematical theory and practice, and empirical observation and recording, have enabled the wider use of graphics and new advances in form and content. Below is an overview of the intellectual history of data visualization from medieval to modern times, as well as descriptions and illustrations of some significant advances along the way.[@data_viz_history].
