...
There are very active Tableau social media groups [@inkedIn_Groups]:
...
------------------------------|--------------------------------------------------------|----------------------
[@charts_viz] | This is a helpful resource where one can find different types of plots that can be used in data visualization. | [https://datavizcatalogue.com](https://datavizcatalogue.com/search.html)
[@eagereyes_viz]  |  Robert Kosara's website which contains recent developments happening in visualization. | [https://eagereyes.org](https://eagereyes.org)
[@research_viz]  |  This link to Tableau's Research webpage includes information about Robert Kosara and his research papers. Here is a link to Robert Kosara's [twitter handle](https://twitter.com/eagereyes?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor). | [https://research.tableau.com/user/robert-kosara](https://research.tableau.com/user/robert-kosara)
