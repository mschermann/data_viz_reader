 ...
 **the Future of Data Visualization**
  **Reference** 
  https://www.quora.com/What-is-the-future-of-data-visualization/answer/Amolie-Sharma?share=b747885e&srid=tk2i
  
  1. Better Tools
  With this prevalence of data access comes a need for data tools to become more approachable and easier to use.
  
  2. Data Visualization For All
  With these newer, easier-to-use tools comes the ability for everyone, from the data-savvy to the data-averse to visualize information that pertains to their specific business needs
  
  3. More Common Chart Types
  With the increasing literacy in data analysis comes an increasing comfort with various chart types. 
  
  4. Increase in Interactivity/Animation
  Interactivity and animation within data analysis encourages exploration and discovery of a certain dataset. 
