...
### How to choose best form of Visualization
...
1. It provides non technical user the ability to build complex reports and dashboard with zero coding skills. 
...
3. Another application: preattentive visual attributes
