...
Reference_clean_w4
  ...
  **Practitioners Guide to Best Practices in Data Visualization**
  ...
  Brain processes stimuli from our environment to process what is important in 2 ways â€? unconscious (System 1 represents
  uncontrolled functions such as facial expressions, reactions) and conscious (System 2 â€? represents controlled function
  ...
  2. Avoid Clutter
     Keep it simple. To implement this always keep into account the data-ink ratio â€? the ratio of ink required to convey
...
The only new thing in the world is the history you donâ€™t know. â€? Harry S Truman
...
Among the most important problems of the 17th century were those concerned with physical measurementâ€? of time,distance,and spaceâ€? for astronomy, surveying, map making, navigation and territorial expansion. This century also saw great new growth in theory and the dawnof practical application.
...
2.2.5 1850â€?1900: The Golden Age of statistical graphics
       
By the mid-1800s, all the conditions for the rapid growth of visualization had been establishedâ€? a â€œperfect stormâ€? for data graphics. Official state statistical offices were established throughout Europe, in recognition of the growing importance of numerical information for social planning,industrialization, commerce, and transportation. 
          
2.2.5.1 Escaping flatland
2.2.5.2 Graphical innovations
2.2.5.3 Galtonâ€™s contributions
2.2.5.4 Statistical Atlases
           
2.2.6 1900-1950: The modern dark ages
       
If the late 1800s were the â€œgolden ageâ€? of statistical graphics and thematic cartography, the early 1900s can be called the â€œmodern dark agesâ€? of visualization. There were few graphical innovations, and, by the mid-1930s, the enthusiasm for visualization which characterized the late 1800s had been supplanted by the rise of quantification and formal, often statistical, models in the social sciences.
       
2.2.7 1950â€?1975: Re-birth of data visualization
...
2.2.8 1975â€“present: High-D, interactive and dynamic data visualization
...
## 4. Guide to Best Practices in Data Visualization
  ...
  The brain processes stimuli from our environment to process what is important in 2 ways â€? unconscious (System 1 represents
  uncontrolled functions such as facial expressions, reactions) and conscious (System 2 â€? represents controlled function
...
Keep it simple. To implement this always keep into account the data-ink ratio â€? the ratio of ink required to conveythe intended meaning to the total amount of ink used in the table or chart should be as close to 1 as possible. That means, avoid ink which do not add any information.

4.3.	Use color purposely and effectively 
      
Use of color may be prettier and attractive but can be distractive too. Thus, color should be used only if it assist in conveying your message. 
...
## 5. Survey of Popular Data Visualization Tools
...
## 8. Definions of Date Deception and Graphic Integrity
  ...
  Data deception, defined by School of Law at the New York University, as â€œa graphical depiction of information, designed with
  ...
  principles of graphic integrity. Here are the principles from book:
    ...
    4. In time-series displays of money, deï¬‚ated and standardized units of monetary measurement are nearly always better than
    nominal units.
...
## 9. Contemporary Research Results & What's Next
  ...
  courses. Useful examples include Jake Wobbrockâ€™s Practical Statistics for HCI and Pierre Dragicevicâ€™s resources for
...
Highlighted in the article are preattentive visual attributes; preattentive attributes are those that perceptual psychologists have determined to be easily recognized by the human brain irrespective of how many items are displayed.  Therefore, â€œpreattentive visual attributes are desirable in data visualization as they can demand attention only when a target is present, can be difficult to ignore, and are virtually unaffected by load.â€?  Examples of preattentive attributes are size/area, hue, and curvature.  
...
However, the authors also point out that despite the dearth of typographic attributes in data visualization, other spheres like typography, cartography, mathematics, chemistry, and programming â€œhave a rich history with type and font attributes that informs the scope of the parameter space.â€?
...
13.1 enefits of Interactive Data Visualization Software:
