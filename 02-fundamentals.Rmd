...
### Design Principles for Graphs

According to Edward Tufte, a Professor Emeritus in Political Science, Computer Science & Statistics at Yale University, and a colossus in the sphere in data visualization, creating good graphics from statistical data requires conveying the complex inferences and trends from that data in a clear, precise and efficient manner (Tufte, 1983). He says that - 

  _Graphical displays should_

  * _show the data_
  * _induce the viewer to think about the substance rather than about methodology, graphic design, the technology        of graphic production, or something else_
  * _avoid distorting what the data have to say_
  * _present many numbers in a small space_
  * _make large data sets coherent_
  * _encourage the eye to compare different pieces of data_
  * _reveal the data at several levels of detail, from a broad overview to the fine structure_
  * _serve a reasonably clear purpose: description, exploration, tabulation, or decoration_
  * _be closely integrated with the statistical and verbal descriptions of a data set_
 
 Tufte, E.R. (1983). The Visual Display of Quantitative Information. _Grqaphics Press._
