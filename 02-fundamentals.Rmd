...
Edward Tufte expounds well on the key points that go towards making good visuals from data. According to him, graphics should be made in such a way that they reveal the underlying data in a clear and precise way. He prescribes the following principles - 
  - show the data
...
Edward R. Tufte, (2007). *The Visual Display of Quantitative Information*. Chesire, CT: Graphics Press. 
