...
## 5. Picking the Right Chart Type
  ...
  scatter plots for  joint variation of two data items 
  bubble charts showing joint variation of three data items 
  pie charts to compare parts of a whole.
  
  Let's review the most commonly used chart types and explain what circumstances should better use typical chart and the pros
...
## 7. Definions of Data Deception and Graphic Integrity
