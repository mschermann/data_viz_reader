...
The followin tips for Tableau are still missing:
1. Running totals
2. Common Baseline
3. Weighted averages
4. Moving average
...
**The key advantages** are: It provides non technical user the ability to build complex reports and dashboard with zero coding skills. Using drag-n-drop functionalities of Tableau, user can create a very interactive visuals within minutes. It can handle millions of rows of data with ease and users can make live to connections to different data sources like SQL etc [@VizBP][@ExtremePre].
