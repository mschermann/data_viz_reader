...
* **Deliver value in your gragh.** One gragh may look good but no value. A gragh with high value should be able to deliver important insight so that it can help make decision or understand something better. Keep in mind, the final goal is to deliver value, and each skill is going to help achieve it.
 
* **To know your audience is hard but most important part.** For the same chart, different audience will have different feeling. So when we have the argument and data, we should decide which way to show our data according to our audience.
